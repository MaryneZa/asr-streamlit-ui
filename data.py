...
upload_csv_files(folder_path=r"D:\work\Natcha-04", group_size=20)

download_csv_file(
    remote_file_path="cee-06/train.csv", local_destination_folder="D:/work"
)
download_csv_file(
    remote_file_path="cee-06/val.csv", local_destination_folder="D:/work"
)
